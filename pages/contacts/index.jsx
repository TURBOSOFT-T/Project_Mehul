      ...
      <ul className="contact">
        <div className="link">
          <li>
            ...
            <a href="https://facebook.com/UbahTheBuilder">
              {" "}
              Like me on Facebook
            </a>
          </li>
        ...
        <div className="link">
          <li>
            ...
            <a href="https://twitter.com/UbahTheBuilder">
              {" "}
        ...
        <div className="link">
          <li>
            ...
            <a href="https://linkedin.com/UbahTheBuilder">
              {" "}
        ...
        <div className="link">
          <li>
            ...
            <a href="https://whatsapp.com/UbahTheBuilder">
              {" "}
